...
const DynamicForm: React.FC<Props> = ({
	...
	const handleNextClick = () => {
		...
		goToNextStep(selectedOption?.nextStep || null);
	};
	...
	return (
		<div className="min-h-full rounded-xl bg-[#c2e812] flex flex-col items-center justify-center">
					...
					<div>
								...
								<button
                                    ...
                                    ${
										selectedOption?.title === option.title
											? "border-[#715aff] border-2"
											: "border-gray-200 hover:border-[#715aff]"
									} flex flex-col`}
								>
									{option.image && (
						...
						<div className="flex justify-between mt-6">
							...
							<button
								...
								className="px-4 py-2 border rounded-lg bg-[#715aff] text-white hover:bg-[#5b4bcf] disabled:opacity-50 disabled:cursor-not-allowed"
							>
								Next
							</button>
						</div>
				...
				{step.fields && (
					...
					>
								...
								<div key={index} className="space-y-1">
									...
									{field.type === "select" ? (
										<select
											...
											className="w-full px-3 py-2 border rounded-lg bg-gray-50 text-zinc-900 border-gray-300 focus:outline-none focus:border-[#715aff]"
										>
											<option value="">
										...
										<textarea
											...
											className="w-full px-3 py-2 border rounded-lg bg-gray-50 text-zinc-900 border-gray-300 focus:outline-none focus:border-[#715aff] resize-y"
											style={{
												minHeight: "100px",
												maxHeight: "300px",
											}}
										...
										<input
											...
											className="w-full px-3 py-2 border rounded-lg bg-gray-50 text-zinc-900 placeholder-gray-400 border-gray-300 focus:outline-none focus:border-[#715aff]"
											placeholder={`Enter ${field.fieldname}`}
										/>
									)}
								</div>
						...
						<div className="flex justify-between mt-6">
							...
							<button
								type="submit"
								className="px-4 py-2 border rounded-lg bg-[#715aff] text-white hover:bg-[#5b4bcf]"
							>
								Next
							</button>
						</div>
